 ...
 *
 * These eight fields were spelled out three times — twice being written in [JobController] and once
...
internal fun FilterOps.pairs(): Array<Pair<String, Any?>> = arrayOf(
    ...
    FilterWorker.KEY_PER_REGION_NSFW to perRegionNsfw,
...
internal fun Data.filterOps(): FilterOps = FilterOps(
    ...
    perRegionNsfw = getBoolean(FilterWorker.KEY_PER_REGION_NSFW, false),
